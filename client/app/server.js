...
export function postComment(feedItemId, author, contents, cb) {
  sendXHR('POST', '/post-comment/' + feedItemId, {
      "author": author,
      "contents": contents,
 ...
 */
 export function likeComment(feedItemId, commentIdx, userId, cb) {
     sendXHR('PUT', '/feeditem/' + feedItemId + '/likeComment/' + commentIdx + '/id/' + userId,
         undefined, (xhr) => {
             cb(JSON.parse(xhr.responseText));
         });
 }
  ...
  */
  export function unlikeComment(feedItemId, commentIdx, userId, cb) {
      sendXHR('DELETE', '/feeditem/' + feedItemId + '/unlikeComment/' + commentIdx + '/id/' + userId,
          undefined, (xhr) => {
              cb(JSON.parse(xhr.responseText));
          });
  }
